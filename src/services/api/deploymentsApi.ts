...
export const updateDeployment = async (appName: string, deploymentName: string, updateData: { rollout?: number; description?: string; appVersion?: string; isMandatory?: boolean; label?: string }) => {
